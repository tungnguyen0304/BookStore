...
--
-- Host: localhost
-- Generation Time: Mar 31, 2023 at 08:08 AM
...
CREATE TABLE `order` (
  ...
  `method` char(1) NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
(1, 'qwwwwwwer', '1234567', '1', 'Nguyễn Văn Á', '0909090909', 'ltuut@hghgh.cjh', '123/123, Xa Lộ Hà Nội');
